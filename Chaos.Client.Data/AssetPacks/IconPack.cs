...
///     (e.g. <c>skill0001.png</c>, matching legacy EPF naming). Decoded <see cref="SKImage" /> results must be disposed
///     by the caller; typical pattern is to run them through <c>Chaos.Client.Rendering.TextureConverter.ToTexture2D</c>
///     and cache the resulting <c>Texture2D</c>.
/// </summary>
